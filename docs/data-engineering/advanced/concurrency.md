...
- ACID; isolation levels and the anomalies they prevent; MVCC; locks and deadlocks; connection pooling.
- Python concurrency choices; the 'claim next subject' worker-pool pattern.
